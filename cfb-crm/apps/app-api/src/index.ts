  ...
  try {
    ...
    const { output } = await db.execute(
      'dbo.sp_CreatePlayer',
      {
        ...
        Parent1Name:           b.parent1Name           ?? null,
        Parent1Phone:          b.parent1Phone          ?? null,
        Parent1Email:          b.parent1Email          ?? null,
        Parent2Name:           b.parent2Name           ?? null,
        Parent2Phone:          b.parent2Phone          ?? null,
        Parent2Email:          b.parent2Email          ?? null,
        Notes:                 b.notes                 ?? null,
