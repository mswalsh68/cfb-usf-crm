...
-- RLS is disabled per-block so DELETEs are not filtered.
-- ============================================================
...
ALTER SECURITY POLICY dbo.alumni_security_policy WITH (STATE = OFF);
...
ALTER SECURITY POLICY dbo.roster_security_policy WITH (STATE = ON);
ALTER SECURITY POLICY dbo.alumni_security_policy WITH (STATE = ON);
